...
<div class="pp_slideshow_wrapper">
	...
	<?for ($i = 0; $i < $numImages; $i++) { ?>
			<p><a href="<?=wfGetPad('/Special:GallerySlide'.$fileUrl[$i].',,'.$articleID.',,'.$revid.',,inline')?>" class="gallery_link" style="background-image:url(<?=wfGetPad($thumbUrl[$i])?>)"></a></p>
	<?}?>
		</div>
	</div>
