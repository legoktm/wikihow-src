...
</pre>This means the English articles were translated into the corresponding Spanish articles.)  <br/>Translation links will be added to the database. A nightly, batch script, will use this database to add InterWiki links to the site where they don't already exist. The message <a href="/MediaWiki:addll-editsummary">&quot;<?php echo wfMsg('addll-editsummary') ?>&quot;</a> will be added in the edit summary when it automatically adds interwiki links. The message <a href="/MediaWiki:removell-editsummary">&quot;<?php echo wfMsg("removell-editsummary") ?>&quot;</a> will be added in the edit summary when interwiki links are removed.
		</div>
