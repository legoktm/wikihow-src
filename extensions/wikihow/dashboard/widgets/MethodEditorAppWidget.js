...
WH.dashboard.AltMethodGuardianAppWidget = (function($) {
    ...
    function AltMethodGuardianAppWidget() {

        this.getWidgetName = function(){
            return "AltMethodGuardianAppWidget";
        }

        // Called by WH.dashboard.init after it's done running
        this.init = function() {
            unpatrolledNode = $('.comdash-widget-AltMethodGuardianAppWidget .comdash-count span');
            lastImage = $('.comdash-widget-AltMethodGuardianAppWidget .comdash-lastcontributor .avatar');
            lastName = $('.comdash-widget-AltMethodGuardianAppWidget .comdash-lastcontributor .name');
            lastTime = $('.comdash-widget-AltMethodGuardianAppWidget .comdash-lastcontributor .time');
            completedNode = $('.comdash-widget-AltMethodGuardianAppWidget .comdash-today');
            topImage = $('.comdash-widget-AltMethodGuardianAppWidget .comdash-topcontributor .avatar');
            topName = $('.comdash-widget-AltMethodGuardianAppWidget .comdash-topcontributor .name');
            topTime = $('.comdash-widget-AltMethodGuardianAppWidget .comdash-topcontributor .time');

            /*$('.comdash-widget-AltMethodGuardianAppWidget .comdash-start').click(function(){
             gatTrack('comm_engagement', 'categorize_start', 'dashboard');
             });
             $('.comdash-widget-AltMethodGuardianAppWidget .comdash-login').click(function(){
    ...
    AltMethodGuardianAppWidget.prototype = new WH.dashboard.DashboardWidget();

    // Instantiate this widget
    widget = new AltMethodGuardianAppWidget();

    // Listen for data updates from the server
    WH.dashboard.registerDataListener('AltMethodGuardianAppWidget', widget);
