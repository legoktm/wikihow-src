...
//-->
	...
	<? endif; ?>
<?= Skin::makeVariablesScript( $wgOut->getJSVars ) ?>
	...
	<? foreach ($otherLanguageLinks as $lang => $url): ?>
		...
		<div id="header_outer"><div id="header">
			...
			<? if ((int)$sk->notifications_count > 0): ?>
