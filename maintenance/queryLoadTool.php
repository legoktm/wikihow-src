...
class QueryLoadTool extends Maintenance {
	...
	public function execute() {
		global $IP;
		require_once("../extensions/wikihow/dedup/dedupQuery.php");
		require_once("../extensions/wikihow/dedup/dedupQueryInput.php");
		require_once("../extensions/wikihow/dedup/titleReconcile.php");

		if($this->hasOption('loaddata')) {
