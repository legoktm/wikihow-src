...
/** 
 * Send an email about language links, where one or more of the articles has been moved, deleted, or redirected 
 * 
 */
...
foreach($allLangs as $lang) {
	...
	$sql = "select tl_from_lang, tl_from_aid, tl_to_lang, tl_to_aid FROM " . $langDB . ".daily_edits de"
				 . " JOIN wikidb_112.translation_link tl on (tl.tl_from_aid=de.de_page_id AND tl_from_lang='$lang') or (tl.tl_to_lang='$lang' AND tl.tl_to_aid=de.de_page_id)"
...
if($moved != "" || $deleted != "" || $redirected!="") {
	...
	if(@$_SERVER['HOSTNAME']=="doh.wikidiy.com") {
		...
		$to = new MailAddress("gershon@wikihow.com, bridget@wikihow.com, chris@wikihow.com, elizabeth@wikihow.com");
	}
